...
merged = load("btageff2023pre.merged")
tagger = "PNetUParT" #"UParTAK4"
outdir = "btageff2023pre"
...
for mc in mcs:
    ...
    for wp in wps:
        for flav, flav_name in flavours.items():
            ...
            fig.tight_layout()
            fig.savefig(f"plots/{outdir}/{mc}_{flav_name}_{wp}.png", dpi=200)
            plt.close(fig)

            print(f"saved: plots/{outdir}/{mc}_{flav_name}_{wp}.png")
