    ...
    def process(self, events):
        ...
        regions = {
            ...
            'cat5_DY2E_highDeltaM': [
                ...
                'electron_trigger',
                'zero_trk_e', 'zero_trk_m', 'zero_trk_pi',
                'zero_t','five_j_clean_l', 'one_b', 'zero_m', 'two_e',
            ...
            'cat6_DY2M_highDeltaM': [
                ...
                'muon_trigger',
                'zero_trk_e', 'zero_trk_m', 'zero_trk_pi',
                'zero_t','five_j_clean_l', 'one_b', 'zero_e', 'two_m',
        ...
        if not isData:
            ...
            bbw = get_btag_weight('UParTAK4', self._year, 'medium', caller)
            tmp = bbw.btag_weight(j_good.pt, j_good.eta, j_good.hadronFlavour, j_good.isupartM)
