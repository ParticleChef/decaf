...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        shifts = [({ "AK15PFPuppiJet": fatjets}, None)]
        if self._systematics:
            #shifts.extend([
            #    ({"Jet": jets.JES_jes.up, "AK15PFPuppiSubJet": subjets.JES_jes.up, "AK15PFPuppiJet": fatjets.JES_jes.up, "MET": met.JES_jes.up}, "JESUp"),
            #    ({"Jet": jets.JES_jes.down, "AK15PFPuppiSubJet": subjets.JES_jes.down,"AK15PFPuppiJet": fatjets.JES_jes.down, "MET": met.JES_jes.down}, "JESDown"),
            #    ({"Jet": jets, "AK15PFPuppiSubJet": subjets, "AK15PFPuppiJet": fatjets, "MET": met.MET_UnclusteredEnergy.up}, "UESUp"),
            #    ({"Jet": jets, "AK15PFPuppiSubJet": subjets, "AK15PFPuppiJet": fatjets, "MET": met.MET_UnclusteredEnergy.down}, "UESDown"),
            #])
            shifts.extend([
                ({"AK15PFPuppiJet": fatjets.JES_jes.up}, "JESUp"),
                ({"AK15PFPuppiJet": fatjets.JES_jes.down }, "JESDown"),
                ({"AK15PFPuppiJet": fatjets}, "UESUp"),
                ({"AK15PFPuppiJet": fatjets}, "UESDown"),
            ])
            if not self._skipJER:
                #shifts.extend([
                #    ({"Jet": jets.JER.up, "AK15PFPuppiSubJet": subjets.JER.up, "AK15PFPuppiJet": fatjets.JER.up, "MET": met.JER.up}, "JERUp"),
                #    ({"Jet": jets.JER.down, "AK15PFPuppiSubJet": subjets.JER.down, "AK15PFPuppiJet": fatjets.JER.down, "MET": met.JER.down}, "JERDown"),
                #])
                shifts.extend([
                    ({"AK15PFPuppiJet": fatjets.JER.up  }, "JERUp"),
                    ({"AK15PFPuppiJet": fatjets.JER.down}, "JERDown"),
                ])
