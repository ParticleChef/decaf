...
print(
    ...
    bkg['metpt']['SMS-2Stop-Par-mStop-600'][{
...
# Plot config
# ----------------------------------------------------------------------
#regions = ['cat1_preselection', 'cat2_highDeltaM', 'cat3_highDeltaM_nobselection', 'cat4_zero_b', 'cat5_one_b', 'cat6_two_b', 'cat7_highDeltaM_tightb']
regions = ['cat1_preselection', 'cat2_LLCR', 'cat3_QCDCR', 'cat5_highDeltaM_tightB']
systematics = 'nominal'

# MC stack 순서/색
#stacks = ['W (lnu)', 'QCD Multijet', 'TT', 'Single Top']
#colors = ['green', 'lightblue', 'yellow', 'orange']
stacks = ['VV','Single Top', 'TT', 'W (lnu)','Z (inv)', 'QCD Multijet']
#colors = ['','orange', 'yellow', 'green','salmon', 'lightblue']
colors = ['#6b705c','#8e7dbe', '#99c1b9', '#f1e3d3', '#f2d0a9', '#d88c9a']
...
# ----------------------------------------------------------------------
for regions in ['cat1_preselection', 'cat2_LLCR_highDeltaM', 'cat3_QCDCR_highDeltaM', 'cat4_highDeltaM_mediumB', 'cat5_highDeltaM_tightB', 'cat6_highDeltaM_looseB']: #['cat1_preselection', 'cat2_highDeltaM_mediumB', 'cat3_highDeltaM_tightB', 'cat4_highDeltaM_looseB']:
    for key in bkg.keys():
        if 'sumw' in key:
            continue
